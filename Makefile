...
iohk-nix:
	git clone git@github.com:input-output-hk/iohk-nix.git -b marlowe-owned-pioneers-testnet
...
run-wallet: marlowe-cardano iohk-nix
	cardano-wallet serve --testnet iohk-nix/cardano-lib/marlowe-pioneers/byron-genesis.json \
	                     --database wallet.db                                               \
